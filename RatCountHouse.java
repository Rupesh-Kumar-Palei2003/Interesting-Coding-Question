...
its argument ‘r’ represents the number of rats present in an area, ‘unit’ is the amount of food each rat consumes and
...
public class RatCountHouse {
    public static int findRatCountHouse(int rat, int unit, int size, int[] arr){
        if(arr.length == 1) {
            return -1;
        }
        int sum =0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findRatCountHouse(30, 2, 8, arr));
    }
}
